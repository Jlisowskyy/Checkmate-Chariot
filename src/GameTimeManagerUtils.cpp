...
std::tuple<lli, lli, lli>
GameTimeManagerUtils::ParseGoTimeInfo(const GoTimeInfo &tInfo, const Color &color) {
    ...
    lli incrementMs = (color == BLACK ? tInfo.bInc : tInfo.wInc);// Get the time left for the engine to play (on the clock)
