...
class ModuloFreeNoOffsetRookMap
{
   ...
   private:
    static constexpr _hashFuncT funcs[Board::BoardFields]{
        _hashFuncT(std::make_tuple(1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 256)),
        _hashFuncT(std::make_tuple(1LLU, 256)), _hashFuncT(std::make_tuple(1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 256)),
        _hashFuncT(std::make_tuple(1LLU, 256)), _hashFuncT(std::make_tuple(1LLU, 128)),
