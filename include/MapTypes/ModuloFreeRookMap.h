...
class ModuloFreeRookMap
{
    ...
    constexpr ModuloFreeRookMap()
    {
        for (int i = 0; i < Board::BoardFields; ++i)
        {
            ...
            MoveInitializer(
                ...
                [](const uint64_t b, const RookMapGenerator::MasksT& m) constexpr { return b; }, boardIndex);
        }
    }
   ...
   private:
    static constexpr _hashFuncT funcs[Board::BoardFields]{
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 64)),  _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 256)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 256)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 256)),
        _hashFuncT(std::make_tuple(1LLU, 1LLU, 256)), _hashFuncT(std::make_tuple(1LLU, 1LLU, 128)),
