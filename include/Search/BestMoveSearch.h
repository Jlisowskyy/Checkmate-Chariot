...
class BestMoveSearch
{
    ...
    int _search(int alpha, int beta, int depthLeft, uint64_t zHash, Move prevMove, PV &pv);

    template <SearchType searchType> int _qSearch(int alpha, int beta, uint64_t zHash, int extendedDepth);
