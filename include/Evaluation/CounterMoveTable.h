...
/*
 *  Class used to implement so called counter move heuristic. The idea is that
 *  some moves have natural response to be played especially in close positions.
 *  Table is used to save non capture moves that caused beta cut-offs in past as an response on some move.
