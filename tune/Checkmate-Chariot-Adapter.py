...
engine_param_cmd = 'tune {name} {value}'

# A pool of opponents for the engine. The opponent will be
# chosen based on the seed sent by CLOP.
opponents = [
    'conf=Checkmate-Chariot',
    # 'conf=bumblebee',
    # 'conf=snowy'
]

# Additional cutechess-cli options, eg. time control and opening book
options = '-each tc=40/1+0.05 option.Hash=512 -draw movenumber=80 movecount=5 score=5 -resign movecount=5 score=500'
